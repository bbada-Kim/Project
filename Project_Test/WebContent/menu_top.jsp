...
<div class="gnb">
	<ul>
		<li><a href="#">헌혈증기부</a>
			<ul>
				<li><a href="${pageContext.request.contextPath}/gibuWriteForm.b">기부신청</a></li>
				<li><a href="${pageContext.request.contextPath}/gibuList.b">기부신청현황</a></li>
				<li><a href="${pageContext.request.contextPath}/bloodWrite.re">요청신청</a></li>
				<li><a href="${pageContext.request.contextPath}/RequestList.re">요청신청현황</a></li>
			</ul>
		</li>
